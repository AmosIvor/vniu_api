...
namespace vniu_api.Migrations
{
    ...
    [Migration("20240408010923_20240408_CreateProductsTable")]
    partial class _20240408_CreateProductsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("vniu_api.Models.EF.Products.Variation", b =>
                {
                    ...
                    b.Property<int?>("SizeOptionSizeId")
                        .HasColumnType("int");

                    b.HasKey("VariationId");

                    b.HasIndex("SizeOptionSizeId");
            ...
            modelBuilder.Entity("vniu_api.Models.EF.Products.Product", b =>
                {
                    b.HasOne("vniu_api.Models.EF.Products.ProductCategory", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("vniu_api.Models.EF.Products.ProductItem", b =>
                {
                    ...
                    b.HasOne("vniu_api.Models.EF.Products.Variation", null)
                        .WithMany("ProductItems")
            ...
            modelBuilder.Entity("vniu_api.Models.EF.Products.Variation", b =>
                {
                    b.HasOne("vniu_api.Models.EF.Products.SizeOption", null)
                        .WithMany("Variations")
                        .HasForeignKey("SizeOptionSizeId");
                });
